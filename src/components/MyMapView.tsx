...
import { activateToolsMeasurementLine, deactivateToolsMeasurementLine, deactivateToolsMeasurementArea, activateToolsMeasurementArea } from '../utils/toolbarActions';
...
const MyMapView = (mapProps: IMapProps) => {
